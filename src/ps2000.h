...
PREF0 PREF1 short PREF2 PREF3(ps2000_open_unit)	 ( void );

PREF0 PREF1 short PREF2 PREF3(ps2000_get_unit_info) (
                                        short handle,
                                        char * string,
                                        short string_length,
                                        short line);

PREF0 PREF1 short PREF2 PREF3(ps2000_flash_led)	 ( short handle );

PREF0 PREF1 short PREF2 PREF3(ps2000_close_unit) ( short handle );

PREF0 PREF1 short PREF2 PREF3(ps2000_set_channel) (
									  short handle,
                                      short	channel,
                                      short	enabled,
                                      short	dc,
...
PREF0 PREF1 short PREF2 PREF3(ps2000_get_timebase) (
									   short handle,
									   short  timebase,
									   long   no_of_samples,
									   long  * time_interval,
...
PREF0 PREF1 short PREF2 PREF3(ps2000_set_trigger) (
									  short handle,
									 short	source,
									 short	threshold,
									 short	direction,
...
PREF0 PREF1 short PREF2 PREF3(ps2000_set_trigger2) (
									  short handle,
									 short	source,
									 short	threshold,
									 short	direction,
...
PREF0 PREF1 short PREF2 PREF3(ps2000_run_block) (
									short handle,
								   long	no_of_values,
								   short	timebase,
								   short	oversample,
...
PREF0 PREF1 short PREF2 PREF3(ps2000_run_streaming) (
									 short handle,
                   short sample_interval_ms,
                   long max_samples, 
                   short windowed);

PREF0 PREF1 short PREF2 PREF3(ps2000_run_streaming_ns) (
										short handle,
...
PREF0 PREF1 short PREF2 PREF3(ps2000_ready) ( short handle );

PREF0 PREF1 short PREF2 PREF3(ps2000_stop) ( short handle );

PREF0 PREF1 long PREF2 PREF3(ps2000_get_values) (
									short handle,
									short * buffer_a,
									short * buffer_b,
									short * buffer_c,
...
PREF0 PREF1 long PREF2 PREF3(ps2000_get_times_and_values) (
	short handle,
	long  * times,
	short * buffer_a,
	short * buffer_b,
...
PREF0 PREF1 short PREF2 PREF3(ps2000_last_button_press) (short handle);

PREF0 PREF1 long PREF2 PREF3(ps2000_set_ets) (
								 short handle,
								 short mode,
								 short ets_cycles,
								 short ets_interleave);

PREF0 PREF1 short PREF2 PREF3(ps2000_set_led)(
	short handle,
	short state);

PREF0 PREF1 short PREF2 PREF3(ps2000_open_unit_async) (void);
PREF0 PREF1 short PREF2 PREF3(ps2000_open_unit_progress) ( short * handle, short * progress_percent );

PREF0 PREF1 short PREF2 PREF3 (ps2000_get_streaming_last_values) (
	short handle,
  GetOverviewBuffersMaxMin);

PREF0 PREF1 short PREF2 PREF3 (ps2000_overview_buffer_status)(
	short handle, 
	short * previous_buffer_overrun);

PREF0 PREF1 unsigned long PREF2 PREF3 (ps2000_get_streaming_values) (
	short handle,
	double * start_time,
	short * pbuffer_a_max,
	short * pbuffer_a_min,
...
PREF0 PREF1 unsigned long PREF2 PREF3 (ps2000_get_streaming_values_no_aggregation)(
	short handle,
	double *start_time,
	short * pbuffer_a,
	short * pbuffer_b,
...
PREF0 PREF1 short PREF2 PREF3(ps2000_set_light) (short handle, short state);

PREF0 PREF1 short PREF2 PREF3(ps2000_set_sig_gen_arbitrary)
	(
	 	short												handle,
	 	long												offsetVoltage,
...
PREF0 PREF1 short PREF2 PREF3(ps2000_set_sig_gen_built_in)
	(
		short												handle,
		long												offsetVoltage,
		unsigned long								pkToPk,
...
PREF0 PREF1 short PREF2 PREF3 (ps2000SetAdvTriggerChannelProperties)
	(
		short																handle,
...
PREF0 PREF1 short PREF2 PREF3 (ps2000SetAdvTriggerChannelConditions)
	(
		short									handle,
...
PREF0 PREF1 short PREF2 PREF3 (ps2000SetAdvTriggerChannelDirections)
	(
		short								handle,
...
PREF0 PREF1 short PREF2 PREF3 (ps2000SetPulseWidthQualifier)
	(
		short										handle,
...
PREF0 PREF1 short PREF2 PREF3 (ps2000SetAdvTriggerDelay)
  (
  short					handle,
  unsigned long	delay,
